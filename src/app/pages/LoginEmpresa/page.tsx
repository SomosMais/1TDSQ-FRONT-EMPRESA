...
const LoginEmpresa = () => {
  ...
  // Descomente se quiser redirecionar usuários já logados
  // useEffect(() => {
    ...
    <>
      <div className="w-full h-[300px] rounded-t-lg">
        ...
        <Image
          ...
          width={250}
          height={220}
          className="-translate-y-[230px] translate-x-[100px]"
        />
      </div>
      ...
      <form onSubmit={handleLoginEmpresa}>
        <div className="w-full h-[400px] flex flex-col items-center justify-center">
          ...
          <br />
          <Link href={"/pages/RedefinirSenhaEmpresa"} className="text-[#E63946]">
            Esqueci a senha
          </Link>
        </div>
      </form>
